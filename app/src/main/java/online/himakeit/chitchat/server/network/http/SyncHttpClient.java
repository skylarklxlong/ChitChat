...
public class SyncHttpClient {
    ...
    public SyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, "SealTalk v" + Constant.SEALTALKVERSION + " (Android; targetsdkversion " + Build.VERSION.SDK_INT + ";)");
...
//		}
        ...
        try {
            ...
            if (!TextUtils.isEmpty(scheme) && ASSETS_PATH.equals(scheme)) {
                ...
                KLog.e(tag, "responseBody : " + responseBody);
                return responseBody;
            }
