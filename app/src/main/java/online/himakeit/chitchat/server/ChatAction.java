...
import online.himakeit.chitchat.server.request.AddGroupMemberRequest;
import online.himakeit.chitchat.server.request.AddToBlackListRequest;
import online.himakeit.chitchat.server.request.AgreeFriendsRequest;
import online.himakeit.chitchat.server.request.ChangePasswordRequest;
import online.himakeit.chitchat.server.request.CheckPhoneRequest;
import online.himakeit.chitchat.server.request.CreateGroupRequest;
import online.himakeit.chitchat.server.request.DeleteFriendRequest;
import online.himakeit.chitchat.server.request.DeleteGroupMemberRequest;
import online.himakeit.chitchat.server.request.DismissGroupRequest;
import online.himakeit.chitchat.server.request.FriendInvitationRequest;
import online.himakeit.chitchat.server.request.JoinGroupRequest;
import online.himakeit.chitchat.server.request.LoginRequest;
import online.himakeit.chitchat.server.request.QuitGroupRequest;
import online.himakeit.chitchat.server.request.RegisterRequest;
import online.himakeit.chitchat.server.request.RemoveFromBlacklistRequest;
import online.himakeit.chitchat.server.request.RestPasswordRequest;
import online.himakeit.chitchat.server.request.SendCodeRequest;
import online.himakeit.chitchat.server.request.SetFriendDisplayNameRequest;
import online.himakeit.chitchat.server.request.SetGroupDisplayNameRequest;
import online.himakeit.chitchat.server.request.SetGroupNameRequest;
import online.himakeit.chitchat.server.request.SetGroupPortraitRequest;
import online.himakeit.chitchat.server.request.SetNameRequest;
import online.himakeit.chitchat.server.request.SetPortraitRequest;
import online.himakeit.chitchat.server.request.VerifyCodeRequest;
import online.himakeit.chitchat.server.response.AddGroupMemberResponse;
import online.himakeit.chitchat.server.response.AddToBlackListResponse;
import online.himakeit.chitchat.server.response.AgreeFriendsResponse;
import online.himakeit.chitchat.server.response.ChangePasswordResponse;
import online.himakeit.chitchat.server.response.CheckPhoneResponse;
import online.himakeit.chitchat.server.response.CreateGroupResponse;
import online.himakeit.chitchat.server.response.DefaultConversationResponse;
import online.himakeit.chitchat.server.response.DeleteFriendResponse;
import online.himakeit.chitchat.server.response.DeleteGroupMemberResponse;
import online.himakeit.chitchat.server.response.DismissGroupResponse;
import online.himakeit.chitchat.server.response.FriendInvitationResponse;
import online.himakeit.chitchat.server.response.GetBlackListResponse;
import online.himakeit.chitchat.server.response.GetFriendInfoByIDResponse;
...
import online.himakeit.chitchat.server.response.GetUserInfoByPhoneResponse;
import online.himakeit.chitchat.server.response.GetUserInfosResponse;
import online.himakeit.chitchat.server.response.JoinGroupResponse;
import online.himakeit.chitchat.server.response.LoginResponse;
import online.himakeit.chitchat.server.response.QiNiuTokenResponse;
import online.himakeit.chitchat.server.response.QuitGroupResponse;
import online.himakeit.chitchat.server.response.RegisterResponse;
import online.himakeit.chitchat.server.response.RemoveFromBlackListResponse;
...
import online.himakeit.chitchat.server.response.SetFriendDisplayNameResponse;
import online.himakeit.chitchat.server.response.SetGroupDisplayNameResponse;
import online.himakeit.chitchat.server.response.SetGroupNameResponse;
import online.himakeit.chitchat.server.response.SetGroupPortraitResponse;
import online.himakeit.chitchat.server.response.SetNameResponse;
import online.himakeit.chitchat.server.response.SetPortraitResponse;
import online.himakeit.chitchat.server.response.SyncTotalDataResponse;
...
public class ChatAction extends BaseAction {
    ...
    * */
    ...
    public RegisterResponse register(String nickname, String password, String verification_token) throws HttpException {
        ...
        String result = httpManager.post(mContext, url, entity, CONTENT_TYPE);
        if (!TextUtils.isEmpty(result)) {
            KLog.e("RegisterResponse", result);
    ...
    public GetTokenResponse getToken() throws HttpException {
        ...
        if (!TextUtils.isEmpty(result)) {
            KLog.e("GetTokenResponse", result);
    ...
    public ChangePasswordResponse changePassword(String oldPassword, String newPassword) throws HttpException {
        ...
        if (!TextUtils.isEmpty(result)) {
            KLog.e("ChangePasswordResponse", result);
    ...
    public RestPasswordResponse restPassword(String password, String verification_token) throws HttpException {
        ...
        if (!TextUtils.isEmpty(result)) {
            KLog.e("RestPasswordResponse", result);
