package online.himakeit.chitchat.message;
 ...
 * @des:
 */
@MessageTag(value = "", flag = MessageTag.ISCOUNTED | MessageTag.ISPERSISTED)
    ...
    public byte[] encode() {
        ...
        try {
            ...
            if (getJsonMentionInfo() != null) {
                jsonObject.putOpt("mentionInfo", getJsonMentionInfo());
            }
            return jsonObject.toString().getBytes("UTF-8");
        } catch (JSONException e) {
            KLog.e(TAG, "JSONException : " + e.getMessage());
        } catch (UnsupportedEncodingException e) {
            KLog.e(TAG, "UnsupportedEncodingException : " + e.getMessage());
        }
